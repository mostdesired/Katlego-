...
class _LoginRegisterState extends State<LoginRegister> {
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: _loading == true
                              ...
                              : Container(
                                  child: filledButton("LOGIN", Colors.white, primaryColor, primaryColor, Colors.white, _validateLoginInput),
                                  height: 50,
                                  width: MediaQuery.of(context).size.width,
                                ),
                        ),
                    ...
                    child: Column(children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: _loading
                            ...
                            : Container(
                                child: filledButton("REGISTER", Colors.white, primaryColor, primaryColor, Colors.white, _validateRegisterInput),
                                height: 50,
                                width: MediaQuery.of(context).size.width,
                              ),
                      ),
    ...
    return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            Padding(
              child: Container(
                child: filledButton("LOGIN", primaryColor, Colors.white, Colors.white, primaryColor, loginSheet),
                height: 50,
              ),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('_displayName', _displayName));
  }
}
